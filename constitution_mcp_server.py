...
def search_constitution(keyword: str) -> str:
    ...
    if content is None:
        raise ValueError(f"Failed to load content for constitution matching '{keyword}'")
    
    return content

# Register resources
app.add_resource_fn(list_constitutions, uri="constitutions://list")
app.add_resource_fn(search_constitution, uri="constitutions://search/{keyword}")
